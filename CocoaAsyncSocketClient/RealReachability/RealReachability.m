...
//            NSDictionary<NSString *,NSString *> *accessStringDict = teleInfo.serviceCurrentRadioAccessTechnology;
//            if ([accessStringDict allKeys].count > 0) {
//                accessString = [accessStringDict allValues][0];
